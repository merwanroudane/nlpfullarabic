# -*- coding: utf-8 -*-
"""
سحب النصوص الحرفية للمؤتمرات الصحفية (Press Conference Scripts).

Scraper for FOMC press-conference transcripts.
...
class FomcPresConfScript(FomcBase):
    '''
    صنف عملي لاستخراج النصوص الحرفية للمؤتمرات الصحفية (Press Conference Scripts) من موقع اللجنة.
    وهي متاحة من أفريل 2011 فقط.

    A convenient class for extracting press conference scripts from the FOMC website.
    Available only from April 2011.
